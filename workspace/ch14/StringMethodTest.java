...
public class StringMethodTest {
    public static void main(String[] args) {
        ...
        // 9. toUpperCase(): 소문자로 변환
        System.out.println(str.toUpperCase());

        // 10. str에 "java"문자열이 나오는 인덱스를 출력하세요(6);
        // 단, 대소문자는 구분하지 않습니다.

        System.out.println(str.toLowerCase().indexOf("java".toLowerCase()));

        // 11. trim(): 문자열 앞, 뒤의 공백제거;
        String str3 = "     Hello Java World    ";
        System.out.println(str3.trim());

        // 12. str이 "Hello" 문자열로 시작하는가
        System.out.println(str.startsWith("Hello"));    // true

        // 13. Hello 1000개로 이루어진 문자열 생성
        String str4 = "Hello ";
        System.out.println(str4.repeat(1000));
    }
}
